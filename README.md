...
一个本地运行的 macOS 弥散渐变生成器，支持自定义画布比例、颜色、RGB 数值、弥散数量、弥散大小和拖拽位置，并可导出 PNG 或复制 CSS 渐变代码。

## 直接使用

下载 Release 里的 `弥散渐变生成器-mac.zip`，解压后双击 `弥散渐变生成器.app` 即可打开。
